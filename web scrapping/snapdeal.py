...
# Change keyword here for other categories like "papad", "saree", etc.
BASE_URL = "https://www.snapdeal.com/search?keyword=basket"
...
async def main():
    async with async_playwright() as p:
        ...
        try:
            df_existing = pd.read_csv("snapdeal_scrapped_data.csv")
            df_combined = pd.concat([df_existing, df_new], ignore_index=True)
        except FileNotFoundError:
            df_combined = df_new

        df_combined.to_csv("snapdeal_scrapped_data.csv", index=False)
